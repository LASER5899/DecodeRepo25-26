...
public class far_blue_9 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d pose8 = new Pose2d(-6, -3, Math.toRadians(20));
        ...
        TrajectoryActionBuilder one = drive.actionBuilder(pose0)
                .strafeToLinearHeading(new Vector2d(-6, -3), Math.toRadians(20));//, new TranslationalVelConstraint(10));
        ...
        TrajectoryActionBuilder three = drive.actionBuilder(pose3)
                .strafeToConstantHeading(new Vector2d(-28, -51), new TranslationalVelConstraint(7.5));
        ...
        TrajectoryActionBuilder six = drive.actionBuilder(pose6)
                .strafeToConstantHeading(new Vector2d(-48, -45), new TranslationalVelConstraint(7.5));
