...
@TeleOp(name="Teleop_practice", group="Linear OpMode")
//@Disabled
public class Teleop_practice extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            lights.setColor(LEDlights.aqua);
            ...
            */
            ...
            if (C_LATERAL >0){
                lights.setColor(LEDlights.blue);
            }

            if (C_LATERAL <0){
                lights.setColor(LEDlights.confetti);
            }
            ...
            if (slideHorizontal.getCurrentPosition() > -200) {
                ...
                // lights.setColor(LEDlights.sky_Blue);
            }
            ...
            */
            ...
            telemetry.addData("C_Axual", "%4.2f", C_AXIAL);
