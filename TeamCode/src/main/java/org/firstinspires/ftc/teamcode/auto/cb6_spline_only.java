 ...
 */
public class cb6_spline_only extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d pose1 = new Pose2d(48, 23, Math.toRadians(50));
        Pose2d pose2 = new Pose2d(48, -17, Math.toRadians(-90));
        Pose2d pose3 = new Pose2d(48, 23, Math.toRadians(50));
        ...
        TrajectoryActionBuilder jarvisRun1 = drive.actionBuilder(pose0)
                .setTangent(Math.toRadians(25))
                .splineToSplineHeading(new Pose2d(9, 4, Math.toRadians(50)),25)
                .setTangent(Math.toRadians(25))
                .splineToSplineHeading(new Pose2d(48, 23, Math.toRadians(50)),25);

        TrajectoryActionBuilder jarvisRun2 = drive.actionBuilder(pose1)
                .setTangent(Math.toRadians(90))

                .splineToSplineHeading(new Pose2d(48, 10, Math.toRadians(50)),-90)

                .setTangent(Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(48, -17, Math.toRadians(50)),90, new TranslationalVelConstraint(10));

        TrajectoryActionBuilder jarvisRun3 = drive.actionBuilder(pose2)
                .setTangent(Math.toRadians(90))
                .splineToSplineHeading(new Pose2d(48, 23, Math.toRadians(50)),90);

        TrajectoryActionBuilder jarvisRun4 = drive.actionBuilder(pose3)
