...
//@Disabled
    public class ShotPositioner extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            double C_LATERAL=0, C_AXIAL=0, C_YAW=0, C_HORIZ_SLIDE = 0, C_HORIZ_SLIDE_RESET=0;
            boolean C_HALF_SPEED, C_INV_DIR = false, C_OUT_SERVO=false,
                    C_IN_SERVO_TRANSF=false, C_INTAKE=false, C_SPIT=false,
                    C_VERT_SLIDE_UP = false, PREV_C_VERT_SLIDE_UP = false,
                    C_VERT_SLIDE_DWN = false, PREV_C_VERT_SLIDE_DWN = false,
                    C_BPUSHSERVO=false, C_BPUSHSERVO_LOAD=false, C_VERT_SLIDE_RESET=false, GO_TO_POSITION_TRUE=false;
            ...
            cam1 = hardwareMap.get(WebcamName.class, "Camera1");
        ...
        int hSlidePos = 0; */
            ...
            while (opModeIsActive()) {
                ...
                GO_TO_POSITION_TRUE = gamepad1.a;
            ...
            */
            ...
            switch (vSlideMotorState) {
                case 0:
                    if (C_VERT_SLIDE_UP && !PREV_C_VERT_SLIDE_UP) {
                        vSlideMotorState = 1;
                    }
                    slideVertical.setPower(1.0);
                ...
                case 1:
                    if (C_VERT_SLIDE_UP && !PREV_C_VERT_SLIDE_UP) {
                        vSlideMotorState = 2;
                    } else if (C_VERT_SLIDE_DWN && !PREV_C_VERT_SLIDE_DWN) {
                        vSlideMotorState = 0;
                    }
                    slideVertical.setPower(1.0);
                    ...
                    break;
                case 2:
                    if (C_VERT_SLIDE_DWN && !PREV_C_VERT_SLIDE_DWN) {
                        vSlideMotorState = 1;
                    }
