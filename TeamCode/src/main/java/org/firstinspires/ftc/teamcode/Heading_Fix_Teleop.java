...
@TeleOp(name="Heading_Fix_Teleop", group="Linear OpMode")
public class Heading_Fix_Teleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        boolean C_HALF_SPEED, C_INV_DIR, C_INTAKE, C_TRANSFER_PA, C_TRANSFER_PB, C_TRANSFER_PC, C_FLICK, HEADING_FREEZE;
